    ...
    <StyledPrivacySection ref={revealContainer}>
      <StyledPrivacyContent>
        <StyledInnerSection>
          ...
          <h3 className="innerDistance">2. HOSTING UND CONTENT DELIVERY NETWORKS (CDN)</h3>
          ...
          <h3 className="innerDistance">3. GENERAL NOTES AND MANDATORY INFORMATION</h3>
          ...
          <h4>NOTE TO THE RESPONSIBLE PARTY</h4>
          ...
          <h4>NOTE ON DATA TRANSFER TO THE USA</h4>
          ...
          <h4>RIGHT TO OBJECT TO THE COLLECTION OF DATA IN SPECIAL CASES AND TO DIRECT ADVERTISING</h4>
          ...
          <h4>RIGHT OF COMPLAINT TO THE COMPETENT SUPERVISORY AUTHORITY</h4>
          ...
          <h4>INFORMATION, DELETION AND RECTIFICATION</h4>
          ...
          <h3 className="innerDistance">4. DATA COLLECTION ON THIS WEBSITE</h3>
          ...
          <h4>REQUEST BY E-MAIL OR PHONE</h4>
          ...
          <h3 className="innerDistance">5. ANALYSIS TOOLS AND ADVERTISING</h3>
